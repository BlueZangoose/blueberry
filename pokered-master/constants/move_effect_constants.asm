...
;	const_skip                       ; $23 used to be Blizzard in JP version (30% FRZ)
;	const PARALYZE_SIDE_EFFECT2      ; $24
	...
	const POISON_SIDE_EFFECT_25			; $57
	const POISON_SIDE_EFFECT_40			; $58
	const PARALYZE_SIDE_EFFECT_15		; $59
	const PARALYZE_SIDE_EFFECT_25		; $5A
	const BURN_SIDE_EFFECT_10			; $5B 
	const BURN_SIDE_EFFECT_18			; $5C
	const BURN_SIDE_EFFECT_30			; $5D (special for black gas)
	const SLEEP_SIDE_EFFECT_8			; $5E
	const SLEEP_SIDE_EFFECT_14			; $5F
	const FREEZE_SIDE_EFFECT_6			; $60
	const FREEZE_SIDE_EFFECT_11			; $61
	const ACRID_SIDE_EFFECT				; $62
	const MEGAVOLT_SIDE_EFFECT			; $63
	const CHANGE_USER_TYPE_EFFECT_GROUND; $64
	const CHANGE_USER_TYPE_EFFECT_GRASS ; $65
	const CHANGE_TARGET_TYPE_EFFECT_FIRE; $66
	const FLINCH_SIDE_EFFECT_10			; $67
	const FLINCH_SIDE_EFFECT_20			; $68
	const FLINCH_SIDE_EFFECT_30			; $69
	const FLINCH_SIDE_EFFECT_50			; $6A
	const FLINCH_EFFECT					; $6B
	const BURN_EFFECT					; $6C
	const BURN_COUNTEREFFECT			; $6D
	const POISON_COUNTEREFFECT			; $6E
	const PARALYZE_COUNTEREFFECT		; $6F
	const CURE_STATUS_EFFECT			; $70
	const ATK_DOWN_SIDE_EFFECT_10		; $71
	const DEF_DOWN_SIDE_EFFECT_10		; $72
	const SPD_DOWN_SIDE_EFFECT_10		; $73
	const SPC_DOWN_SIDE_EFFECT_10		; $74
	const ACC_DOWN_SIDE_EFFECT_10		; $75
	const EVA_DOWN_SIDE_EFFECT_10		; $76
	const ATK_DOWN_SIDE_EFFECT_30		; $77
	const DEF_DOWN_SIDE_EFFECT_30		; $78
	const SPD_DOWN_SIDE_EFFECT_30		; $79
	const SPC_DOWN_SIDE_EFFECT_30		; $7A
	const ACC_DOWN_SIDE_EFFECT_30		; $7B
	const EVA_DOWN_SIDE_EFFECT_30		; $7C
	const ATK_DOWN_SIDE_EFFECT_50		; $7D
	const DEF_DOWN_SIDE_EFFECT_50		; $7E
	const SPD_DOWN_SIDE_EFFECT_50		; $7F
	const SPC_DOWN_SIDE_EFFECT_50		; $80	; this is 128
	const ACC_DOWN_SIDE_EFFECT_50		; $81
	const EVA_DOWN_SIDE_EFFECT_50		; $82
	const ATK_DOWN_SIDE_EFFECT_100		; $83
	const DEF_DOWN_SIDE_EFFECT_100		; $84
	const SPD_DOWN_SIDE_EFFECT_100		; $85
	const SPC_DOWN_SIDE_EFFECT_100		; $86
	const ACC_DOWN_SIDE_EFFECT_100		; $87
	const EVA_DOWN_SIDE_EFFECT_100		; $88
	const CHARGE_PARALYZE_EFFECT		; $89
	const CHARGE_BOOST_EFFECT			; $8A
	const POISON_SIDE_EFFECT_100		; $8B
	const PARALYZE_SIDE_EFFECT_100		; $8C
	const BURN_SIDE_EFFECT_100			; $8D	
	const ATK_UP_SIDE_EFFECT_50			; $8E
	const DEF_UP_SIDE_EFFECT_20			; $8F
