...
CeladonMart2Clerk2Text::
	script_mart TM_FLAMETAIL, TM_CHILLTAIL, TM_STONETAIL, TM_HYDROTAIL, TM_WYRMTAIL, TM_MANTIS_SLASH, TM_SURPRISEPNCH, TM_OMEN_SCREAM, TM_SUPERSAP
...
CheatHouseCashier1Text::
	script_mart MOON_STONE, OLD_AMBER, DOME_FOSSIL, HELIX_FOSSIL, TRADE_STONE
