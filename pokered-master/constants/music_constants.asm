...
BATTLE_SFX_START EQUS "SFX_STARFIRE"	; changed, was peck
	music_const SFX_STARFIRE,           SFX_Starfire	; changed, was peck
	music_const SFX_FAINT_FALL,         SFX_Faint_Fall
	music_const SFX_BATTLE_09,          SFX_Battle_09
	music_const SFX_LEAF_CHOMP,         SFX_Leaf_Chomp
	...
	music_const SFX_ACID_SPIT,          SFX_Acid_Spit
	...
	music_const SFX_BLADE_STRIKE,       SFX_Blade_Strike
	music_const SFX_BATTLE_1E,          SFX_Battle_1E
	music_const SFX_KO_KICK,         SFX_KO_Kick	; changed, was horn drill
	...
	music_const SFX_PSIONIC_SLAM,            SFX_Psionic_Slam	; changed, was psybeam
	music_const SFX_BATTLE_2E,          SFX_Battle_2E
	music_const SFX_BATTLE_2F,          SFX_Battle_2F
	music_const SFX_FALLING_STAR,          SFX_Falling_Star		; changed, was psychic
